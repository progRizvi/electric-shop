                ...
                <div class="container">
                        ...
                        <div class="col-xl-8">
                            <ul class="list-unstyled">
                                <li class="text-muted">To: <span
                                        style="color:green ;">{{ auth('customer')->user()->name }}</span></li>

                                <li class="text-muted">{{ $Order->address }}</li>
                                <li class="text-muted"><i class="fa fa-phone"></i> 01123456789</li>
                            </ul>
                        </div>
                        <div class="col-xl-4">
                            <p class="text-muted">Invoice</p>
                            <ul class="list-unstyled">
                                <li class="text-muted"><i class="bi bi-award" style="color:green ;"></i> <span
                                        class="fw-bold">ID:</span>{{ $Order->id }}</li>
                                <li class="text-muted"><i class="bi bi-alarm" style="color:green ;"></i> <span
                                        class="fw-bold">Creation Date: </span>
                                    @if ($order_details->count() > 0)
                                        {{ $order_details[0]->created_at->toDateString() }}
                                    @endif
                                </li>
                                <li class="text-muted"><i class="bi bi-bezier2" style="color:green ;"></i> <span
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3">
                            ...
                            <p class="text-black float-start"><span class="text-green me-3"> Total Amount</span><span
